  ...
  if (mediaType === 'image') {
    return (
      <animated.span style={{ width: '100vw', height: '100vh', backgroundImage: `url(${url})`, backgroundSize: 'cover', backgroundPosition: 'bottom 1% right 1%', aspectRatio: "16/9", position: "fixed" }} >
        <p style={{ fontSize: '15vw', color: 'rgba(255, 255, 255, 0.5)', width: '100%', height: '30%', backgroundColor: 'rgba(50, 50, 73, 0.5)', aspectRatio: "16/9" }}>{titles[idx]}</p>
      </animated.span>
    );
  } else if (mediaType === 'video') {
    return (
      <animated.span style={{ width: '100vw', height: '100vh', aspectRatio: "16/9" }} >
        <p style={{ zIndex: '100', fontSize: '15vw', color: 'rgba(255, 255, 255, 0.5)', width: '100%', height: '30%', backgroundColor: 'rgba(50, 50, 73, 0.5)', aspectRatio: "16/9" }}>{titles[idx]}</p>
